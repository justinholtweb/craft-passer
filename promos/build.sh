...
# Output: promos/out/passer-promo-N.png at 1920x1080 (rendered at 2x, downsampled).
set -euo pipefail
...
for n in $SLIDES; do
  "$CHROME" \
    ...
    --screenshot="out/passer-promo-$n.png" \
    "file://$PWD/slides.html?s=$n" >/dev/null 2>&1
  sips --resampleWidth 1920 "out/passer-promo-$n.png" >/dev/null
  echo "  built out/passer-promo-$n.png"
done
